...
//   const [currentTab, setCurrentTab] = useState("Volunteer"); // Use "Volunteer" instead of "candidate"
...
//   function handleCandidateFormValid() {
//     const isValid = Object.keys(candidateFormData).every(
//       (key) => candidateFormData[key].trim() !== ""
//     );
//     console.log("Validation Status:", isValid, candidateFormData);
//     return isValid;
//   }
...
//             buttonText={"Onboard as Volunteer"}
